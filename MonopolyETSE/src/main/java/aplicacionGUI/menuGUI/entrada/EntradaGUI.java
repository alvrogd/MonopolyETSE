...
public class EntradaGUI {
    ...
    public EntradaGUI(Group raiz, MenuGUI menuGUI){
        ...
        this.nodo.getTransforms().add(new Translate(ConstantesGUI.ENTRADA_DESPLAZAMIENTO_X, ConstantesGUI.ENTRADA_DESPLAZAMIENTO_Y));

        this.sensor = new Rectangle(0, 0, ConstantesGUI.ENTRADA_ANCHO, ConstantesGUI.ENTRADA_ALTO);
        this.sensor.setFill(Color.TRANSPARENT);

        this.canvas = new Canvas(ConstantesGUI.ENTRADA_ANCHO, ConstantesGUI.ENTRADA_ALTO);
        ...
        this.nodoTextField.getTransforms().add(new Translate(ConstantesGUI.ENTRADA_DESPLAZAMIENTO_X + 10, ConstantesGUI.ENTRADA_DESPLAZAMIENTO_Y + 25));
        ...
        this.boton = new Rectangle(ConstantesGUI.ENTRADA_DESPLAZAMIENTO_BOTON_X, ConstantesGUI.ENTRADA_DESPLAZAMIENTO_BOTON_Y,
                25, 25);
    ...
    public void setActivo(boolean activo) {
        ...
        getGc().clearRect(0,0,ConstantesGUI.ENTRADA_ANCHO, ConstantesGUI.ENTRADA_ALTO);
    ...
    public boolean contienePosicion(double x, double y){
        double posicionX = x - ConstantesGUI.ENTRADA_DESPLAZAMIENTO_X;
        double posicionY = y - ConstantesGUI.ENTRADA_DESPLAZAMIENTO_Y;
