...
public final class Constantes
{
    ...
    public final static double PRECIO_INICIAL_GRUPO_8 = PRECIO_INICIAL_GRUPO_7 * ( 1 + INCREMENTO_GRUPO );
    ...
    public final static double SUMA_PRECIO_SOLARES = 2 * PRECIO_INICIAL_GRUPO_0 + 3 * PRECIO_INICIAL_GRUPO_1 + 3 *
            ...
            PRECIO_INICIAL_GRUPO_6 + 3 * PRECIO_INICIAL_GRUPO_7 + 2 * PRECIO_INICIAL_GRUPO_8;
