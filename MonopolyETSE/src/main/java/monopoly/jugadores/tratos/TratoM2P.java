...
public class TratoM2P extends Trato {
    ...
    public void aceptar() {
        ...
        aceptar(getEmisor(), getReceptor(), getCantidadDinero(), getPropiedad1());
    }
     ...
     */
    public void aceptar(Jugador emisor, Jugador receptor, int cantidadDinero, Propiedad propiedad1) {
