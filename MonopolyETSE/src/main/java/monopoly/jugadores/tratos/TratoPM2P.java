...
public class TratoPM2P extends TratoP2P {
    ...
    public void aceptar() {
        ...
        aceptar(getEmisor(), getReceptor(), getPropiedad1(), getCantidadDinero(), getPropiedad2());
    }
     ...
     */
    public void aceptar(Jugador emisor, Jugador receptor, Propiedad propiedad1, int cantidadDinero, Propiedad
            propiedad2) {
